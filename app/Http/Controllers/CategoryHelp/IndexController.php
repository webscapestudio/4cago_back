...
class IndexController extends Controller
{
    public function __invoke()
    {
        ...
        return view('faq.categories_asked_questions.index', compact('categories_asked_questions', 'posts_read', 'user', 'asked_questions', 'right_banners', 'left_banners', 'upper_banner'));
    }
}
