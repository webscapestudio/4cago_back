...
var openFilter = document.querySelectorAll('.dropdown__filter');
...
var openDrop = document.querySelectorAll('.login__block');
var openItem = document.querySelector('.create');
var menu = document.querySelector('.profile__item');
...
var openMeat = document.querySelectorAll(".post__drop");
...
var openNotif = document.querySelector('.notifications__block');
