        ...
        @auth()
          <div class="post__actions-left">
            ...
            <form class="{{ auth()->user()->favourite ?? 'active' }}"
              action="{{ route('news.favourite.store', $news->id) }}" method="POST">
              @csrf
          ...
          <div class="post__actions-right">
            ...
            <form class="post__smile post__actions-right-item" action="{{ route('news.like.store', $news->id) }}"
              method="POST">
              @csrf
              <button type="submit">
                @if (auth()->user()->like)
            ...
            <form class="post__smile-sad post__actions-right-item active"
              action="{{ route('news.dislike.store', $news->id) }}" method="POST">
              @csrf
              <button type="submit">
