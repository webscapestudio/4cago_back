...
<form class="form__search" action="{{ route('news.search') }}" method="get">
  <div class="form__top">
...
<div class="post__card ad__card">
  ...
  <div class="post__header">
    <div class="post__header-left">
      <div class="user__avatar">
        <picture>
          <source srcset="{{ asset('./images/avatars/user-ava.webp') }}" type="image/webp"><img src="{{ asset('./images/avatars/user-ava.jpg') }}" alt="user" />
        </picture>
      </div>
  ...
  <div class="post__main">
    ...
    <div class="post__img">
      <picture>
        <source srcset="{{ asset('storage/' . $new->news_image) }}" type="image/webp"><img src="{{ asset('storage/' . $new->news_image) }}" alt="" />
      </picture>
    </div>
    @else
    @endif
  ...
  <div class="post__bottom">
    ...
    <div class="post__actions">
      ...
      <div class="post__actions-left">
        ...
        <form class="{{ auth()->user()->favourite ?? 'active' }}" action="{{ route('news.favourite.store', $new->id) }}" method="POST">
          @csrf
      ...
      <div class="post__actions-right">
        ...
        <form class="post__smile post__actions-right-item" action="{{ route('news.like.store', $new->id) }}" method="POST">
          @csrf
          <button type="submit">
            @if (auth()->user()->like)
            <svg class="icon" viewBox="0 0 24 24" fill="none" fill="#000F13">
        ...
        <form class="post__smile-sad post__actions-right-item active" action="{{ route('news.dislike.store', $new->id) }}" method="POST">
          @csrf
          <button type="submit">
