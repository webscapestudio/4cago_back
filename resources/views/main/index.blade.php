...
<div class="feed">
        ...
        <div class="post__drop">
          <div class="meatballs">
            <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="#000F13">
              ...
              <path d="M12 10C10.9 10 10 10.9 10 12C10 13.1 10.9 14 12 14C13.1 14 14 13.1 14 12C14 10.9 13.1 10 12 10Z" stroke-width="1.5" />
            </svg>
          </div>
    ...
    <div class="post__bottom">
      ...
      <div class="post__actions">
        ...
        <div class="post__actions-left">
          ...
          <a class="post__comments post__actions-left-item" href="{{ route('post.show', [$post->category_id, $post->id]) }}">
  ...
  <div class="feed__ad">
    <div class="feed__header">
      <picture>
        <source srcset="./images/content/vw.webp" type="image/webp"><img src="./images/content/vw.jpg" alt="" />
      </picture>
    ...
    <div class="feed__img">
      <picture>
        <source srcset="./images/content/feed-ad.webp" type="image/webp"><img src="./images/content/feed-ad.jpg" alt="" />
      </picture>
    </div>
