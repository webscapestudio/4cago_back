            ...
            <div class="post__header">
                <div class="post__header-left">
                    <div class="user__avatar">
                        <picture>
                            <source srcset="./images/avatars/user-ava.webp" type="image/webp"><img src="./images/avatars/user-ava.jpg" alt="user" /></picture>
                    </div>
...
/>
            ...
            <div class="post__main">
                <a class="post__title" href="meet-post.html">Осознание</a>
                <div class="post__content">
                    Когда-то, лет 12 назад, довелось мне отдыхать в санатории с пожилой родственницей. Мне тогда было чуть больше двадцати лет. И были там занятия лечебной физкультуры или что-то типа того. Контингент состоял из людей 30+. Я с удовольствием ходила на эти
                    занятия, и с лёгкостью выполняла все упражнения. Не забывая приговаривать, как это просто. Согруппники пыхтели, но молчали. А тётя-доктор смотрела недобро. Сейчас мне 35 и я начала заниматься гимнастикой для
                    спины. И поняла, что я не могу собрать в замок руки за спиной(упражнение). Так вот, простите меня, одногруппники и тётя-доктор. Я всё теперь поняла)
            ...
            <div class="post__bottom">
                <div class="post__tags">
                    <div class="tags">
                        <div class="tag">Физкультура</div>
                        <div class="tag">Спорт</div>
                        <div class="tag">Стыд</div>
                    </div>
                </div>
        ...
        <div class="card__immigrant">
            <div class="post__header">
                <div class="post__header-left">
                    ...
                    <div class="post__date">сегодня в 16:24</div>
                </div>
                <div class="post__header-right">
                    <div class="post__drop">
                        <div class="meatballs">
...
/>
            ...
            <div class="post__main">
                <a class="post__title" href="meet-post.html">Важное для новичков</a>
                <div class="post__content">
                    Когда-то, лет 12 назад, довелось мне отдыхать в санатории с пожилой родственницей. Мне тогда было чуть больше двадцати лет. И были там занятия лечебной физкультуры или что-то типа того. Контингент состоял из людей 30+. Я с удовольствием ходила на эти
                    занятия, и с лёгкостью выполняла все упражнения. Не забывая приговаривать, как это просто. Согруппники пыхтели, но молчали. А тётя-доктор смотрела недобро. Сейчас мне 35 и я начала заниматься гимнастикой для
                    спины. И поняла, что я не могу собрать в замок руки за спиной(упражнение). Так вот, простите меня, одногруппники и тётя-доктор. Я всё теперь поняла)
            ...
            <div class="post__bottom">
                <div class="post__tags">
                    <div class="tags">
                        <div class="tag">Иммигрантам</div>
                        <div class="tag">Важно</div>
                        <div class="tag">Помощь</div>
                    </div>
                </div>
                <div class="post__actions">
                    <div class="post__actions-left">
        ...
        <div class="card__ad">
            <div class="post__header">
                <div class="post__header-left">
                    ...
                    <p class="user__name">Admin</p>
                    <div class="post__date">сегодня в 16:23</div>
                </div>
                <div class="post__header-right">
                    <div class="post__drop">
                        <div class="meatballs">
...
/>
            ...
            <div class="post__main">
                <a class="post__title" href="meet-post.html">Продам авто</a>
                <div class="post__content">Пробег 25000, отдам за 5000$</div>
                <div class="post__img">
                    <picture>
                        <source srcset="./images/content/car.webp" type="image/webp"><img src="./images/content/car.jpg" alt="" /></picture>
                </div>
            </div>
            <div class="post__bottom">
                <div class="post__tags">
                    <div class="tags">
                        <div class="tag">Объявление</div>
                        <div class="tag">Продам</div>
                        <div class="tag">Автомобиль</div>
                    </div>
                </div>
                <div class="post__actions">
                    <div class="post__actions-left">
...
></path>
    ...
    <div class="feed__ad">
        <div class="feed__header">
            <picture>
                <source srcset="./images/content/vw.webp" type="image/webp"><img src="./images/content/vw.jpg" alt="" /></picture>
        ...
        <div class="feed__img">
            <picture>
                <source srcset="./images/content/feed-ad.webp" type="image/webp"><img src="./images/content/feed-ad.jpg" alt="" /></picture>
        </div>
