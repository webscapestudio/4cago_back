...
@section('content')
    <div class="feed">
                ...
                <div class="post__header">
                    ...
                    <div class="post__header-right">
                        <div class="post__drop">
                            ...
                            <div class="dropdown">
                                <p class="title__count">Пожаловаться</p>
                            </div>
                        ...
                        <div class="post__img">
                            <picture>
                                <source srcset="{{ asset('storage/' . $advertisement->advertisements_image) }}"
                                    type="image/webp"><img
                                    src="{{ asset('storage/' . $advertisement->advertisements_image) }}" alt="" />
                            </picture>
                        </div>
                    @else
                    @endif
        ...
        <div class="feed__ad">
            ...
            <div class="feed__img">
                <picture>
                    <source srcset="./images/content/feed-ad.webp" type="image/webp"><img
                        src="./images/content/feed-ad.jpg" alt="" />
                </picture>
            </div>
