<div class="sidebar-right">
  ...
  <div class="aside__ad">
    <a class="side-ad" href="#">
      ...
      <div class="side-ad__banner">
        <picture>
          <source srcset="./images/content/side-ad.webp" type="image/webp"><img src="./images/content/side-ad.jpg" alt="">
        </picture>
      </div>
    </a>
  </div>
  ...
  <div class="aside__ad">
    <a class="side-ad" href="{{ $right_banner->link }}">
      ...
      <div class="side-ad__banner">
        ...
        <picture>
          <source srcset="{{ asset('storage/' . $right_banner->banner_image) }}" type="image/webp"><img src="{{ asset('storage/' . $right_banner->banner_image) }}" alt="" />
        </picture>
        @else
        @endif
      </div>
  ...
  <div class="aside__tags read__now">
    ...
    <div class="aside__tags-items">
      ...
      <div class="read__now-item">
        ...
        <a class="title__link" href="{{ route('post.show', [$post->category_id, $post->id]) }}">{{ $post->title }}</a>
