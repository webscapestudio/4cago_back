          ...
          <div class="profile__menu">
            ...
            <div class="profile__items">
              <ul class="profile__item create">
                ...
                <li class="profile__subitem">
                  <a class="comment__link" href="{{ route('personal.advertisement.index') }}"><svg class="icon fill"
                ...
                <li class="profile__subitem">
                  ...
                  <a class="comment__link" href="{{ route('personal.work.index') }}"><svg class="icon fill"
                      viewBox="0 0 24 24" fill="none" fill="#7D8688">
                      <path
