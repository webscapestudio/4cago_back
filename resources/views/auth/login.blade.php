  ...
  <section class="auth">
    <div class="container">
      ...
      <div class="authorization">
        ...
        @if (session('status'))
          <p class="delete__title">Ваш пароль изменен</p>
          <a class="btn btn__blue" href="{{ route('login') }}">Войти</a>
        @else
          <h2 class="delete__title">Вход в аккаунт</h2>
          <div class="registration__inputs">
            <form class="flexible error" method="POST" action="{{ route('login') }}" novalidate>
              @csrf
              ...
              <input class="input input__password @error('password') error @enderror" type="password" name="password"
