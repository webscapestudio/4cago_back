  ...
  @section('content')
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-6">
            <form class="card card-primary" action="{{ route('admin.left_banner.update', $left_banner->id) }}"
              ...
              <div class="card-body">
                ...
                <select class="form_control" name="published">
                  @if (@isset($left_banner->id))
                    <option value="0" @if ($left_banner->published == 0) selected = "" @endif>Не
                      опубликовано</option>
                    <option value="1" @if ($left_banner->published == 1) selected = "" @endif>
                      Опубликовано</option>
                  @else
