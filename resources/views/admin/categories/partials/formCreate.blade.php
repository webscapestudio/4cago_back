...
<input type="text" class="form-control" name="title" placeholder="Заголовок категории" value="{{ old('title') }}">
...
<div class="form-group">
  ...
  <select class="form-control" name="parent_id">
    ...
    @include('admin.categories.partials.categoriesCreate', ['categories' => $categories])
  </select>
  @error('category_id')
    <div class="text-danger">{{ $message }}</div>
  @enderror
