    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Редактирование контакта</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-6">
            <form class="card card-primary" action="{{ route('admin.contact.update', $contact->id) }}" method="POST"
              ...
              <div class="card-body" style="display: block;">
                ...
                <div class="form-group">
                  <label for="inputDescription">Контакт(ссылка) </label>
                  <input id="inputDescription" class="form-control" name="content" placeholder="Cсылка ..."
