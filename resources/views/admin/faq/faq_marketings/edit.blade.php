    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Редактирование информации о рекламе</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('admin.main.index') }}">Главная</a></li>
                <li class="breadcrumb-item active">Редактирование информации о рекламе</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-6">
            < <form class="card card-primary" action="{{ route('admin.faq_marketing.update', $faq_marketing->slug) }}"
              ...
              <div class="card-body" style="display: block;">
                ...
                <div class="form-group">
                  ...
                  <textarea id="inputDescription" class="tiny_editor" rows="4" style="height: 170px;" name="content"
                    placeholder="Текст ...">{{ $faq_marketing->content }}</textarea>
