  ...
  @section('content')
      ...
      <p class="post__title">Ваши не опубликованные посты.</p>
      ...
      @if (isset($posts) and !$posts->isEmpty())
          ...
          @endforeach
      @endif
      @if ($advertisements->isEmpty() and $posts->isEmpty())
          <p class="post__title">Вы еще не добавили ни одного поста в черновик.</p>
      @endif
