  ...
  @section('content')
      ...
      @if (isset($works) and !$works->isEmpty())
              ...
              <div class="work__card">
                  <div class="work__card-top">
                      ...
                      <div class="post__drop">
                          ...
                          <div class="dropdown">
                              <a href="{{ route('personal.work.edit', $work->id) }}" class="text-success">Изменить</a>

                              <form action="{{ route('personal.work.destroy', $work->id) }}" method="POST">
                                  @csrf
                                  @method('DELETE')
                  ...
                  <a class="post__title" href="work-vacancy.html">{{ $work->title }}</a>
                  @if (file_exists('storage/' . $work->work_image))
                      <div class="post__img">
                          <picture>
          ...
          @endforeach
      @else
          <p class="post__title">Вы еще не создали ни одной вакансии.</p>
          <a href="{{ route('personal.work.create') }}" style="text-align: center" class="btn btn__blue">Создать
              вакансию</a>
      @endif
