  ...
  <form class="vacancy__post"action="{{ route('personal.work.update', $work->id) }}" method="POST"
    ...
    <div class="post-create__inner">
      ...
      <div class="categories">
          ...
          <div class="custom__select">
            ...
            <div class="ss-55358 ss-main" style="">
              <div class="ss-single-selected"><span class="placeholder">Полная</span><span
                  class="ss-deselect ss-hide">x</span><span class="ss-arrow"><span class="arrow-down"></span></span></div>
              <div class="ss-content">
                <div class="ss-search"><input type="search" placeholder="Search" tabindex="0" aria-label="Search"
        ...
        <div class="filter__category">
          ...
          <div class="filter">
            <input type="number" id="before" placeholder="От" name="salary_from" value="{{ $work->salary_from }}">
            @error('salary_from')
              <div class="text-danger">{{ $message }}</div>
            @enderror
            <!-- <label for="before"></label> -->
            <input type="number" id="after" placeholder="До"name="salary_before" value="{{ $work->salary_before }}">
            @error('salary_before')
              <div class="text-danger">{{ $message }}</div>
            @enderror
          ...
          <div class="custom__select">
            ...
            <div class="ss-47908 ss-main" style="">
              <div class="ss-single-selected"><span class="placeholder">Офис</span><span
                  class="ss-deselect ss-hide">x</span><span class="ss-arrow"><span class="arrow-down"></span></span>
              </div>
              <div class="ss-content">
                <div class="ss-search"><input type="search" placeholder="Search" tabindex="0" aria-label="Search"
                    autocapitalize="off" autocomplete="off" autocorrect="off">
                ...
                <div class="ss-list" role="listbox">
                  <div class="ss-option ss-disabled ss-option-selected" role="option" data-id="9756205">Офис</div>
    ...
    <div class="post-create__inner">
      <div class="vacancy__name">
        ...
        <input class="input input__title" type="mail"name="mail_applicants" value="{{ $work->mail_applicants }}">
