      ...
      @foreach ($news_all as $news)
        <div class="post__card ad__card">
          ...
          <div class="post__main">
            <a class="post__title" href="{{ route('news.show', $news->slug) }}">{{ $news->title }}</a>
    ...
    @if (isset($posts) and !$posts->isEmpty())
      @foreach ($posts as $post)
        <div class="post__card ad__card">
          ...
          <div class="post__main">
            <a class="post__title"
              href="{{ route('post.show', [$post->category_id, $post->slug]) }}">{{ $post->title }}</a>
            <div class="post__content js-read-smore" data-read-smore-words="40">
              {{ $post->description }}
      ...
      @endforeach
    @endif
    @if ($posts->isEmpty() and $news_all->isEmpty())
