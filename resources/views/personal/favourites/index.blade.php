  ...
  @section('content')
      <div class="feed">
                      ...
                      <div class="post__header">
                          ...
                          <div class="post__header-right">
                              <div class="post__drop">
                                  ...
                                  <div class="dropdown">
                                      <form action="{{ route('news.favourite.store', $new->id) }}" method="POST">
                                          @csrf
                          ...
                          <div class="post__actions">
                              <div class="post__actions-left">
                                  ...
                                  <form class="{{ auth()->user()->favourite ?? 'active' }}"
                                      action="{{ route('news.favourite.store', $new->id) }}" method="POST">
                                      @csrf
                              ...
                              <div class="post__actions-right">
                                  ...
                                  <form class="post__smile post__actions-right-item"
                                      action="{{ route('news.like.store', $new->id) }}" method="POST">
                                      @csrf
                                      <button type="submit">
                                          @if (auth()->user()->like)
                                              <svg class="icon" viewBox="0 0 24 24" fill="none" fill="#000F13">
                                  ...
                                  <form class="post__smile-sad post__actions-right-item active"
                                      action="{{ route('news.dislike.store', $new->id) }}" method="POST">
                                      @csrf
                                      <button type="submit">
                              ...
                              <div class="post__img">
                                  <picture>
                                      <source srcset="{{ asset('storage/' . $advertisement->post_image) }}"
                                          type="image/webp"><img
                                          src="{{ asset('storage/' . $advertisement->post_image) }}" alt="" />
                                  </picture>
                              </div>
                          @else
                          @endif
          ...
          @if (isset($posts) and !$posts->isEmpty())
              ...
              @endforeach
          @endif
          @if ($advertisements->isEmpty() and $posts->isEmpty() and $news->isEmpty())
