  ...
  @section('content')
      <div class="feed">
              ...
              <div class="profile__card-top">
                  <div class="profile__card-left">
                      ...
                      <div class="user__info">
                          ...
                          <p class="post__date">На форуме с 24 июн 2022</p>
                      </div>
                  </div>
          ...
          @if (isset($advertisements) and !$advertisements->isEmpty())
              <a href="{{ route('personal.advertisement.create') }}" style="text-align: center"
                  class="btn btn__blue">Создать
                  обьявление</a>
                      ...
                      <div class="post__main">
                          ...
                          <div class="post__content">
                              ...
                              <div class="read__full">
                                  <a class="vacancy__link" href="#">Читать полностью</a>
                              </div>
                          </div>
                      ...
                      <div class="post__bottom">
                          ...
                          <div class="post__actions">
                              <div class="post__actions-left">
                                  ...
                                  <a class="post__pins post__actions-left-item active" href="#">
                                      <svg class="icon" viewBox="0 0 24 24" fill="none" fill="#000F13">
                                          <path
                                      ...
                                      <p class="post__pins_num">8</p>
                                  </a>
                              </div>
                              <div class="post__actions-right">
                                  <a class="post__smile post__actions-right-item">
                                      <svg class="icon" viewBox="0 0 24 24" fill="none" fill="#000F13">
                                          <path
                                      ...
                                      <p class="post__smile-num">20</p>
                                  </a>
                                  <a class="post__smile-sad post__actions-right-item active">
                                      <svg class="icon" viewBox="0 0 24 24" fill="none" fill="#000F13">
                                          <path
                                              d="M15.5 11C16.3284 11 17 10.3284 17 9.5C17 8.67157 16.3284 8 15.5 8C14.6716 8 14 8.67157 14 9.5C14 10.3284 14.6716 11 15.5 11Z">
                                          </path>
                                      ...
                                      <p class="post__smile-sad-num">3</p>
                                  </a>
                              </div>
                          </div>
                      </div>
              ...
              @endforeach
          @else
              <p class="post__title">Вы еще не написали ни одного обьявления.</p>
              <a href="{{ route('personal.advertisement.create') }}" style="text-align: center"
                  class="btn btn__blue">Создать
                  обьявление</a>
          @endif
