                  ...
                  <div class="post__card ad__card">
                      ...
                      <div class="post__header">
                          <div class="post__header-left">
                              ...
                              <p class="user__name">{{ $advertisement->author->name }}</p>
                              ...
                              @auth()
                                  ...
                                  <div class="post__actions-right">
                                      ...
                                      <form class="post__smile post__actions-right-item"
                                          action="{{ route('advertisement.like.store', $advertisement->id) }}"
                                          method="POST">
                                          @csrf
                                          <button type="submit">
                                              @if (auth()->user()->like)
                                      ...
                                      <form class="post__smile-sad post__actions-right-item active"
                                          action="{{ route('advertisement.dislike.store', $advertisement->id) }}"
                                          method="POST">
                                          @csrf
                                          <button type="submit">
